...
try
    ...
    % 图片1在屏幕上的位置
    p1horiz = params.horiz/2 - rectp1(1)/2 *3 - 100-100;
    p1verti = params.vertical/2 - rectp1(2)/2;
    rect1 = [p1horiz p1verti p1horiz+rectp1(1) p1verti+rectp1(2)];
    %
    p2horiz = params.horiz/2 - rectp1(1)/2 - 100-50;
    p2verti = params.vertical/2 - rectp1(2)/2;
    rect2 = [p2horiz p2verti p2horiz+rectp1(1) p2verti+rectp1(2)];
    %
    p3horiz = params.horiz/2 + rectp1(1)/2- 100;
    p3verti = params.vertical/2 - rectp1(2)/2;
    rect3 = [p3horiz p3verti p3horiz+rectp1(1) p3verti+rectp1(2)];
    %
    p4horiz = params.horiz/2 + rectp1(1)/2 *3 -50;
